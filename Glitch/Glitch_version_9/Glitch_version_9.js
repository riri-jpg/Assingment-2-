...
function preload() {
    ...
    img = loadImage('data/Fashion4.jpg');
...
function setup_1() {
  ...
  points = myFont.textToPoints('Eyes', (width / 4) - 200, height / 2, 300, {
...
function draw() {
    ...
    let glitchSat = random(25, 50);    // Random saturation
   ...
   // }
    ...
    if (frameCount % 60 === 0) {
        ...
        let yShift = sin(frameCount * 0.09) * 20; 
