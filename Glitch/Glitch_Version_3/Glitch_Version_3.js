 ...
 * 
 * TITLE : ZOOM GLITCH
 * DESCRIPTION: The text gets bigger when the mouse is close on a glitch bg
 * BY :RINI
 *
 */
...
function setup_1() {
  ...
  points = myFont.textToPoints('fashion', (width / 4) - 200, height / 2, 300, {
...
function draw_1() {
  ...
  for (let i = 0; i < points.length; i++) {
    ...
    let circleSize = map(d, 0, 500, 40, 2);
