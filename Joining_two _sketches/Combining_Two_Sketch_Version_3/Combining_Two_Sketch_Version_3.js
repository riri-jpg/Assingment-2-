...
function preload() {
  ...
  bgImage = loadImage("data/Hair.jpg");  //change this to reflect YOUR image
  smallImage = loadImage("data/hairclip.png");        //change to yours
}

function setup() {
    createCanvas(windowWidth, windowHeight);
    imageMode(CORNER); //use this if you need other modes elsewhere
    image(bgImage, 0, 0, width, height, 100, 100, bgImage.width, bgImage.height, COVER);
    //background("bgImage");
    setup_2();
}
...
function draw_2()
{
  ...
  // background(0);
   ...
   image(smallImage, mouseX, mouseY, 0, 0);
   //draw_3();
}
